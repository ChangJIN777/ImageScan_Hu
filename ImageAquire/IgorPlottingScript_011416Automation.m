...
%%
igorDateFull = 'C:\Users\lab\Documents\Data\2016_Jan_14\';%get(handles.esrSavePath,'String');
...
for i=1:numgraphs
    if i < 7
        ...
        igorFolderName = [prefix num2str(i+offset) suffix '000' num2str(i+nv_num_diff+offset)];      
    end
    x1= num2str(xmat(i));
