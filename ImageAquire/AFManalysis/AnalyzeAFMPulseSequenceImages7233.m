...
doLimNormTo_01=; % whether to limit colorscale on iChan=1 (usually norm) to [0,1] interval

%-------------- inputs---------
scanNum = 7236; % scan number in scans directory
npc  = 7;%5 % number of pulse channels, e.g. = 5 for norm,sig1,ref1,sig2,ref2
ncc = 1;%1 % number of custom channels to add, post-processing of existing channels into new visualization
