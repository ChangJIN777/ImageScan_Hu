...
%-------------- inputs---------
scanNum = 7228; % scan number in scans directory
npc  = 5;%5 % number of pulse channels, e.g. = 5 for norm,sig1,ref1,sig2,ref2
...
for iChan=1:npc
    ...
    subplot(2,npc+ncc,iChan+npc+ncc);
    if iChan==1 && doLimNormTo_01
        clims = [0 1];
        imagesc([xmin_um,xmax_um],...
            [ymin_um,ymax_um],...
