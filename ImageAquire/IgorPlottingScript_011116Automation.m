...
%%
igorDateFull = 'C:\Users\lab\Documents\Data\2016_Jan_11\';%get(handles.esrSavePath,'String');
...
for i=1:numgraphs
    if i < -1
        igorFolderName = [prefix num2str(i+offset) suffix '0000' num2str(i+26+offset)];
    else
        igorFolderName = [prefix num2str(i+offset) suffix '000' num2str(i+26+offset)];      
    end
    x1= num2str(xmat(i));
