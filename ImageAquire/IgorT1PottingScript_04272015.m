...
%%
igorDateFull = 'C:\Users\lab\Documents\Data\2015_Apr_24\';%get(handles.esrSavePath,'String');
...
for i=1:numgraphs
    if i < -1
        igorFolderName = [prefix num2str(i) suffix '0000' num2str(i+13)];
    else
        igorFolderName = [prefix num2str(i) suffix '000' num2str(i+13)];      
    end
    x1= num2str(xmat(i));
