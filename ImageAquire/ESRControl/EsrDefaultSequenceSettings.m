...
%   Detailed explanation goes here
    ...
    switch(measurementSelection)
        case 1 % 'Rabi 1 Channel'
            set(handles.tauStart,'String',num2str(10));
            set(handles.tauEnd,'String',num2str(120));
            set(handles.numTauPoints,'String',num2str(56));
            set(handles.repsPerTau,'String',num2str(20000));
            set(handles.depopulationTime,'String',num2str(1000));
            set(handles.preReadoutWait,'String',num2str(1170));
            set(handles.sampleWidth,'String',num2str(50));
            set(handles.delayTimeAOM,'String',num2str(1160));
            set(handles.initTime,'String',num2str(2000));
            set(handles.readoutTime,'String',num2str(400));
            set(handles.fileboxPulseSequence,'String',[handles.EsrGlobalMethods.imageScanHandles.configS.sequenceFolder 'RabiSequence_1channel_SigRefEqual.esr']);
        ...
        case 2 % 'Pulsed ESR freq sweep'
            ...
            set(handles.readoutTime,'String',num2str(400));
            set(handles.fileboxPulseSequence,'String',[handles.EsrGlobalMethods.imageScanHandles.configS.sequenceFolder 'PulsedESR.esr']);
            set(handles.radio1Channel,'Value',1);
        ...
        case 3 % 'Ramsey 2 Channel'
            ...
            set(handles.initTime,'String',num2str(1000));
            set(handles.readoutTime,'String',num2str(400));
            set(handles.fileboxPulseSequence,'String',[handles.EsrGlobalMethods.imageScanHandles.configS.sequenceFolder 'RamseySequence_2channel_50ns.esr']);
