...
%%
igorDateFull = 'C:\Users\lab\Documents\Data\2015_Sep_13\';%get(handles.esrSavePath,'String');
igorDateTrunc = igorDateFull((end-6):(end-1));
latestIndex = num2str(15);%num2str(str2num(get(handles.numCompleted,'String'))-2);
...
for i=1:numgraphs
    if i < 10
        igorFolderName = [prefix num2str(i) suffix '0000' num2str(i+0)];
    else
        igorFolderName = [prefix num2str(i) suffix '000' num2str(i+0)];      
    end
    x1= num2str(xmat(i));
