...
%%
pixels_x = 200;%Zhiran. first dicide how many pixels. This decision is made manually
pixels_y = 200;
periodregi=1800;%Zhiran. set how frequetly for image registration, in seconds
iffirstrun=1;
cyclenum=0;
...
Force_set_pnt = 142.0e-3; %chnage this each time. used only during first AFM scan, %ZHIRAN,MAKE SURE SET POINT IS RIGHT
...
x_points = linspace(-200,200,11);
y_points = linspace(-200,200,11); %ZHIRAN, sets scan window, in nanometers
