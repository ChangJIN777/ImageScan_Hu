function scan_ps_pillar_xy_z_cwesr_T( )
...
x_size_nm = 100; %Dimensions of scan in nm, POSITIVE VALUED
y_size_nm = 400;
if x_size_nm<0
...
nx = 10; %Number of points along x axis
ny = 20; %y axis
nz=3;
...
zrange_nm = [10,100,200]; %[6,10,20,30,40,50,75,100,125,150,200,300];
