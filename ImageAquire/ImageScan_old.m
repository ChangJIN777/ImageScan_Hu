...
%this will notify
    ...
    if handles.StateControl.state == StateControl.SCANNING
        ...
        handles.StateControl.changeToScanningState(handles); %Do this when starting to scan. StateControl is a class.
    end
end
...
% --- Executes during object creation, after setting all properties.
function checkUseZoomboxLimits_CreateFcn(hObject, eventdata, handles)
% hObject    handle to checkUseZoomboxLimits (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
end
