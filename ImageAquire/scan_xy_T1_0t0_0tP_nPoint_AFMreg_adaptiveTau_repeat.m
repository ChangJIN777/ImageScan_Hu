function scan_xy_T1_0t0_0tP_nPoint_AFMreg_adaptiveTau_repeat( )
...
Force_set_pnt = 185.0e-3; %chnage this each time. used only during first AFM scan
...
afm_scan_x_points_numb = 20;
afm_scan_y_points_numb = 20;
...
x_points = linspace(-400,400,51);
%x_points = linspace(-400,400,81);
y_points = linspace(-400,400,51);
...
new_tau_value = 3000e3 + 1000;
T1_limit = 5000e3 + 1000;
