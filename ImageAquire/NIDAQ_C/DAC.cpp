...
{	
	...
	n_samp = 100; //Samples for tip input
	n_chan = 4;
	n_chan_active = 0;
    ...
    tip_chan = /*"PXI1Slot3/ai0"*/"PXI1Slot2/ai17";
...
float DAC::approach_check()
{
	...
	int32 error = DAQmxReadAnalogF64(approach_handle,n_samp,DAQmx_Val_WaitInfinitely,DAQmx_Val_GroupByChannel,value,n_samp,&approach_read,NULL);
   // char str[300];
