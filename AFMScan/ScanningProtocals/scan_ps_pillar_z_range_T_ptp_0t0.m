function scan_ps_pillar_z_range_T_ptp_0t0( )
...
nx=1; ny=1;
nz = 100; %Number of times to visit each height point
setptFrac = 0.92; % fraction of the free R that the setpoint should be
forceSetpt = 25.00*10^-3; %in volts
Pgain = -0.3; % V/Vrms
...
zrange_nm = [1,5,9,13,18,50,100,500];%[10,50, 200, 1000];%[10,13,18,25,30,35,40,50,75,100,175,250,300,400,500];%[10,30,60,90,120,150,200,400,600,1000]; %[6,10,20,30,40,50,75,100,125,150,200,300];
yrange_ns_omega = [800,800,1000,1500,1500,2000,2000,2000]*10^3+500;%[1000,2000 ,4000,4000 ]*10^3+500;%[1000,1000,1200,1200,1400,1800,1800,2000,2400,3500,4500,7000,7000,8000,10000]*10^3+10;%[800,800,800,1000,800,1000,1000,1200,1500,1500,2500,4000]*10^3+10;%[500,500,600,600,700,700,800,800,1000,1000,1000,1200]*10^3;2001000*ones(1,length(zrange_nm));%[1000010,1000010,];%
yrange_ns_gamma = [400,400,400,400,400,400,400,400]*10^3+500;%[2000, 2000, 2000, 2000]*10^3+500;
