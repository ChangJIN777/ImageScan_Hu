function scan_ps_pillar_xy_z_Pulsed_T_Fast( )
...
x_size_nm = 1; %Dimensions of scan in nm, POSITIVE VALUED
y_size_nm = 400;
if x_size_nm<0
...
current_xy = [0,0];
safeLiftZ_endPixel_V = 0.5; % in Volts where 1 um = 1 Volt
safeLiftZ_endLine_V = 0.6; % in Volts where 1 um = 1 Volt
