function scan_xy_T1_0t0_0tP_nPoint_AFMreg( )
...
Force_set_pnt = 25.0e-3; %chnage this each time. used only during first AFM scan
...
Omega_range = [1000e3,2000e3,3000e3,4000e3] +1000;
...
while current_point <= nx*ny
 ...
 % ************** code to re take AFM image 
   ...
   % and engage
   mDAC('move_tip_laser', -xy_points(current_point,1) -scan_size_x*10000/2,-xy_points(current_point,2)-scan_size_y*10000/2,0,0);
   pause(10);
