function scan_ps_pillar_z_range( )
...
nz = 30; %Number of times to visit each height point
...
zrange_nm = 700;%[6,10,20,30,40,50,75,100,125,150,200,300];
yrange_ns = 1200*10^3; %[500,500,600,600,700,700,800,800,1000,1000,1000,1200]*10^3;
