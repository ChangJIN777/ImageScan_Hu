function scan_ps_pillar_z_range_T( )
...
z_size_nm = 3000; %Dimensions of scan in nm, POSITIVE VALUED
if z_size_nm<0
...
zrange_nm = [10,13,18,25,30,35,40,50,75,100,175,250,300,400,500];%[10,30,60,90,120,150,200,400,600,1000]; %[6,10,20,30,40,50,75,100,125,150,200,300];
yrange_ns = [800,800,1000,1000,1200,1500,1500,1800,2000,3000,3000,5000,5000,5000,6000]*10^3+10;%[800,800,800,1000,800,1000,1000,1200,1500,1500,2500,4000]*10^3+10;%[500,500,600,600,700,700,800,800,1000,1000,1000,1200]*10^3;2001000*ones(1,length(zrange_nm));%[1000010,1000010,];%
...
for k=1:nz_all
    if (bTipTrackXY)
     ...
     if (mod(k,galvoTrackPeriod)==0)
        ...
        pause(0.8); % not necessary to pause but could be useful
