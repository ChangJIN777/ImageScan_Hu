...
%         counterLine2 = '/PXI1Slot2/PFI1';
        ...
        % note: in this case, we are only using the first counter in 
        counterLine1 = '/Dev2/PFI0';
        counterLine2 = '/Dev2/PFI1';
...
%         triggerLine3 = '/PXI1Slot3/PFI7';  % external PulseBlaster RF TTL line for counting up/down
        ...
        triggerLine1 = '/Dev2/PFI5'; % internal DAQ clock line/trigger
        triggerLine2 = '/Dev2/PFI3'; % external PulseBlaster counter TTL line

        %analog in for correlated counter, voltage measurement
%         counterVoltageAI = 'PXI1Slot2/ai1'; % APD imput voltage
        counterVoltageAI = 'Dev2/ai1'; % APD imput voltage
...
%             obj.DAQ.addClockLine('PXI1Slot2/ctr0','/PXI1Slot2/PFI12');             
            obj.DAQ.addClockLine('Dev2/ctr0',obj.triggerLine1);  
...
%             obj.DAQ.addCounterInLine('PXI1Slot2/ctr2','/PXI1Slot2/PFI0',DAQManager.CLK2);
            obj.DAQ.addCounterInLine('Dev2/ctr1',obj.counterLine1,DAQManager.CLK1); 
